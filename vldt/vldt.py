...
###############
class Validate:
    def __init__(self, cfg, cfg_ds, cfg_frgb, cfg_vldt, net_pst_fwd, dvc, metrics, watching):
        self.cfg = cfg
        self.dvc = dvc
        ...
        self.DL, _, _ = get_testloader(cfg)
    ...
    def start(self, net):
        ...
        ####################################
        ## try to perform a mean with a window size == FSTEP over the GT 
