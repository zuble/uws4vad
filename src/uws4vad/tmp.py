...
from uws4vad.data import *
from uws4vad.utils import get_log, Visualizer
log = get_log(__name__)


def mpcs(cfg):
    from pytorch_metric_learning.samplers import MPerClassSampler
    from uws4vad.data import LBL, FeaturePathListFinder
...
class Debug():
    ...
    def loss(self):
        ## set debug.model=1
        from uws4vad.model.loss.mgnt import Rtfm
        ...
        loss_cfg = {
            '_target_': 'uws4vad.model.loss.mgnt.Rtfm',
            '_cfg': {
                'k': 3,
                'alpha': 0.0001,
                'margin': 100,
    ...
    def net(self, cfg):
        from uws4vad.model.net.rtfm import Network
        net_cfg = {
            '_target_': 'uws4vad.model.net.rtfm.Network',
            '_cfg': {
                'do': 0.7,
            }
        }
