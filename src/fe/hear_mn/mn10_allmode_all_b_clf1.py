...
from src.fe.hear_mn.models.MobileNetV3 import get_model
from src.fe.hear_mn.models.preprocess import AugmentMelSTFT
from src.fe.hear_mn.hear_wrapper import MNHearWrapper
from src.fe.hear_mn.helpers.utils import NAME_TO_WIDTH


def load_model(model_file_path="", model_name="mn10_as",
            mode=("mel_avgs", "clf1", "b5", "b11", "b13", "b15", "logits")):
...
def get_basic_model(model_name="mn10_as", **kwargs):
    ...
    model = MNHearWrapper(mel=mel, net=net, scene_embedding_size=2087, timestamp_embedding_size=2087, **kwargs)
    return model
